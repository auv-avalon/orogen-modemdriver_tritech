...
#ifndef MODEMDRIVER_MODEM_TASK_HPP
#define MODEMDRIVER_MODEM_TASK_HPP
...
namespace modemdriver {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','modemdriver::Modem')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Modem(std::string const& name = "modemdriver::Modem");
         ...
         * 
         */
        Modem(std::string const& name, RTT::ExecutionEngine* engine);
